...
(this, function ($) {
	...
	Position = {
		...
		intersectsLine : function () {
			...
			return function (b, c, d, e, f, g, h, i, j) {
				if (!j)
					return a(b, c, f, g, h, i) != a(d, e, f, g, h, i) && a(b, c, d, e, f, g) != a(b, c, d, e, h, i);
				var k,
				l,
				m,
				n;
					...
					this._polling = setTimeout(a.proxy(function () {
								...
								if (this._time += this._delay, this._time >= this.options.intervals[this._ipos][0]) {
									if (!this.options.intervals[this._ipos + 1])
										return "function" == a.type(this._timeout) && this._timeout(), void 0;
									this._ipos++,
									this._delay = this.options.intervals[this._ipos][1]
								}
								this.poll()
	...
	var Options = {
		create : function () {
			...
			function d(a) {
				...
				i.ajax && (f.ajax || {}, e.ajax, "boolean" == $.type(i.ajax) && (i.ajax = {}), i.ajax = !1);
				var j,
	...
	$.extend(Skin.prototype, {
		...
		updateBackground : function () {
			...
			if (this.tooltip.title && !this.tooltip.is("loading")) {
				...
				this.element.find(".tpd-background-title, .tpd-background-content").hide(), this.element.find(".tpd-background").css({
					"background-color" : this._css.backgroundColor
				});
	...
	$.extend(Tooltip.prototype, {
		...
		initialize : function (element, content) {
			if (this.element = element, this.element) {
				var options;
				"object" != $.type(content) || _.isElement(content) || _.isText(content) || _.isDocumentFragment(content) || content instanceof $ ? options = arguments[2] || {}
					...
					if (c && b) {
						...
						Support.touch && Browser.MobileSafari && /^(target|element)/.test(a) && /mouse(leave|out)/.test(d) ? this.bind(c, d, function (a) {
							if (this._tooltipTouchEndTime && /^mouse(leave|out)$/.test(a.type)) {
								...
								if (b - this._tooltipTouchEndTime < 450)
									return
							}
							this.is("api", !1),
							this.hideDelayed()
		...
		update : function (a) {
			if (!this.is("updating")) {
                    ...
                    : this.options.ajax
                        ...
                        : (
                            (
                                ...
                                && (
                                    this.options.lee_okToCacheBuilderResult
                                    || !$(this.content).hasClass('builder-result')
                                )
                            )
				...
				case "function":
					...
					if (!c)
						return this.is("updating", !1), a && a(!0), void 0;
					this._update(c, a)
				}
			}
		},
	...
	$.extend(Tooltip.prototype, {
			...
			if (this.visible()) {
				...
				if (this.options.containment) {
					...
					if ($.each("top right bottom left".split(" "), $.proxy(function (a, b) {
							...
							}, this)), h || (f.contained = !0), f.contained)
						this.setPosition(f);
					else {
						g.unshift({
							position : f,
						...
						if (d = j, c = Position.flip(b), i[Position.getSide(d)] ? (this.updateDimensionsToContent(d, c), f = this.getPositionBasedOnTarget(d, c)) : f.contained = !1, f.contained)
							...
							p = k + o,
							q = Position.flip(p);
							if (d = p, c = q, i[Position.getSide(d)] ? (this.updateDimensionsToContent(d, c), f = this.getPositionBasedOnTarget(d, c)) : f.contained = !1, f.contained)
								this.setPosition(f, c);
							else {
								g.unshift({
									position : f,
								...
								if ($.each(g, function (a, b) {
										if (b.position.top >= 0 && b.position.left >= 0)
											r = b;
										else {
		...
		isSideWithinContainment : function (a, b, c) {
			...
			if (Position.isPointWithinBoxLayout(f.x1, f.y1, d) || Position.isPointWithinBoxLayout(f.x2, f.y2, d))
				return !0;
			var g = !1;
		...
		getTargetPosition : function () {
			...
			if ("mouse" == this.options.target)
				if (this.is("api")) {
					...
					a = Mouse.getPosition(this._cache.event);
			else {
