...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\main.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\appData.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\autoDetection.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\calibration.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\colorAnalysis.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\connectedPoints.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\dataSeries.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\dateConversion.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\gridDetectionCore.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\inputParser.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\mathFunctions.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\plotData.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\averagingWindow.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\averagingWindowCore.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\averagingWindowWithStepSize.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\barExtraction.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\blobdetector.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\AEalgos\xStepWithInterpolation.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\bar.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\image.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\map.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\polar.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\ternary.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\core\axes\xy.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\dataSeriesManagement.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\dataTable.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\graphicsWidget.js'
//
...
wpd.graphicsWidget = (function () {
    ...
    function init() {
        ...
        wpd._config.eventHandlerElem = document;
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\layoutManager.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\popups.js'
//
...
wpd.popup = (function () {
    ...
    function startDragging(ev) {
        ...
        wpd._config.appContainerElem.appendChild($dragMask);
    ...
    function moveWindow(ev) {
        var newWindowX = (dragInfo.initialWindowX + ev.pageX - dragInfo.initialMouseX),
            ...
            appWidth = parseInt(wpd._config.appContainerElem.offsetWidth, 10),
            appHeight = parseInt(wpd._config.appContainerElem.offsetHeight, 10),
    ...
    function removeDragMask() {
        if(dragInfo != null && dragInfo.dragMaskDiv != null) {
            ...
            wpd._config.appContainerElem.removeChild(dragInfo.dragMaskDiv);
            dragInfo = null;
        }
    }
...
wpd.busyNote = (function () {
    ...
    function show() {
        ...
        wpd._config.appContainerElem.appendChild(noteDiv);
        isVisible = true;
    }
    ...
    function close() {
        if (noteDiv != null && isVisible === true) {
            ...
            wpd._config.appContainerElem.removeChild(noteDiv);
            isVisible = false;
        }
    }
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\sidebars.js'
//
...
wpd.sidebar = (function () {
    ...
    function show(sbid) { // Shows a specific sidebar
        ...
        sb.style.height = parseInt(wpd._config.appContainerElem.offsetHeight, 10) - 280 + 'px';
    }

    function clear() { // Clears all open sidebars
        var sidebarList = wpd._config.appContainerElem.getElementsByClassName('sidebar'),
            ii;
    ...
    function resize() {
        ...
        for (ii = 0; ii < sidebarList.length; ii++) {
            if (sidebarList[ii].style.display === "inline-block") {
                ...
                sidebarList[ii].style.height = parseInt(wpd._config.appContainerElem.offsetHeight, 10) - 280 + 'px';
            }
        }
    }
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\toolbars.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\transformationEquations.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\webcam.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\widgets\zoom.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\alignAxes.js'
//
...
wpd.alignAxes = (function () {
    ...
    function initiatePlotAlignment(memento) {
        ...
        var idMap = {
            ...
            r_bar: wpd.barCalibration,
            r_polar: wpd.polarCalibration,
            r_ternary: wpd.ternaryCalibration,
            r_map: wpd.mapCalibration,
            r_image: function() {
                calibrator = null;
        ...
        if (memento) {
            ...
            for (var id in idMap) {
                if (idMap.hasOwnProperty(id)) {
                    ...
                    if (elem.checked) {
                        _memento.plotTypeId = id;
                        setCalibrator(idMap[id]);
                        break;
                    }
                }
            }
    ...
    function align() {
        ...
        wpd.appData.isAligned(true);
     // wpd.acquireData.load();
        wpd.acquireMeanVarianceData.load();
    }
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\autodetect.js'
//
    ...
    function run() {
        ...
        var fn = function () {
            var autoDetector = wpd.appData.getPlotData().getAutoDetector(),
                ...
                $paramFields = wpd._config.appContainerElem.getElementsByClassName('algo-params'),
                pi,
                paramId, paramIndex,
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\colorPicker.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\dataProviders.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\graphicsHelper.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\gridDetection.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\imageOps.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\keyCodes.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\manualDataCollection.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\mask.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\meanVarianceDataCollection.js'
//
...
wpd.acquireMeanVarianceData = (function () {
    ...
    function meanVarianceSelection() {
        var tool = new wpd.MeanVarianceSelectionTool();
        wpd.graphicsWidget.setTool(tool);
    }
...
wpd.MeanVarianceSelectionTool = (function () {
    var Tool = function () {
        var plotData = wpd.appData.getPlotData();
        //var button = document.getElementById('mean-variance-select-button');
        ...
        this.onAttach = function () {
            ...
            $dataPointCountEdit.val('3').change();
            $dataSeriesCountEdit.val('4').change();
        };

        function buildTable() {
            var p, s, series, point;
            var dataStructure = $dataStructureList.val();
        ...
        function dataPointCountChanged(ev) {
            console.log("dataPointCountChanged.");
        ...
        this.onKeyDown = function (ev) {
            ...
            if(wpd.keyCodes.isUp(ev.keyCode)) {
                ...
                lastPt.x = lastPt.x + stepSize;
            } else if(wpd.acquireMeanVarianceData.isToolSwitchKey(ev.keyCode)) {
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\measurement.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\tools\perspective.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\ajax.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\args.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\download.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\i18n.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\plotly.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\saveResume.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\scriptInjection.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\services\websockets.js'
//
...
// source file:
//	'N:\dev\PdfExtractor\PdfExtractor.Web\Scripts\wpd\javascript_tweaked\browser\browserInfo.js'
//
